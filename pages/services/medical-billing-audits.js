...
export const medicalBillingAudits = ({ articles }) => {
  return (
    <>
      <Navbar />
      ...
      <section
        ...
        className="work-process work-process-home bg-dark_red pb-xs-80 pb-sm-100 pb-md-100 pb-120 overflow-hidden"
      >
        <div className="container">
          <div className="row">
            <div className="col-12">
              <div className="pricing__content mb-60 mb-sm-40 mb-xs-30 text-center">
                ...
                <h2 className="title color-pd_black">
                  Medical Billing Audit Can Help
                </h2>
              </div>
            </div>
          </div>
          ...
          <div className="row mb-minus-30 last_no_bullet">
            <div className="col-xl-4 col-lg-4 col-sm-6">
              <div className="work-process__item work-process__item-two mb-30 text-center">
                ...
                <div className="text">
                  <div className="description font-la">
                    <p>To identify areas of under-coding / over-coding</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="col-xl-4 col-lg-4 col-sm-6">
              <div className="work-process__item work-process__item-two mb-30 text-center">
                ...
                <div className="text">
                  <div className="description font-la">
                    <p>To protect you against fraudulent billing</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="col-xl-4 col-lg-4 col-sm-6">
              <div className="work-process__item work-process__item-two mb-30 text-center">
                ...
                <div className="text">
                  <div className="description font-la">
                    <p>To prevent the use of outdated procedure codes</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <ServicesTwoColumn
        title="Start Growing Your Practice Now"
...
export default medicalBillingAudits;
